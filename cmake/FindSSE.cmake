...
IF(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  string(REGEX MATCH sse2 SSE_THERE ${CPUINFO})
  string(COMPARE EQUAL  sse2 ${SSE_THERE} SSE2_AVAILABLE)
  if(SSE2_AVAILABLE)
    set(SSE2_FOUND true CACHE BOOL "SSE2 available on host" FORCE)
  endif()
...
if(NOT SSE2_FOUND)
  ...
  MESSAGE(STATUS " support for SSE2 on this machine - ok")
